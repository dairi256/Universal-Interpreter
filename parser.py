class Parser:
    def __init__(self, tokens):     
        self.otkens = tokensself.current_token = 0

    def parse(self):
        ast = self.parse.statement()
    ...
    def parse_statement(self):
        ...
        if self.tokens[self.current_token] == 'KEYWORD':
            keyword = self.tokens[self.current_token]
